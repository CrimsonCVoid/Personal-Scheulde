            ...
            {!isCanvasConnected() ? (
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" onClick={handleImportCanvas} className="flex-1">
                    Import Assignments
                  </Button>
                </div>
                ...
                {importStats.totalCanvasEvents > 0 && (
                  <div className="text-sm text-muted-foreground bg-muted/50 p-3 rounded-lg">
                    <div className="font-medium mb-1">Last Import Summary:</div>
                    <ul className="space-y-1">
                      <li>• {importStats.totalCanvasEvents} total items imported</li>
                      <li>• {importStats.weightedAssignments} weighted assignments</li>
                      <li>• {importStats.courseCount} courses processed</li>
                      {importStats.lastImportDate && (
                        <li className="text-xs">
                          Last updated: {new Date(parseInt(importStats.lastImportDate)).toLocaleString()}
                        </li>
                      )}
                    </ul>
                  </div>
